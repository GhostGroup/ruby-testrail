...
module TestRail
  ...
  class TestRailClient
    ...
    def initialize(testrail_http_client, run_id: nil, run_name: nil)
      @run_name = run_name.present? ? run_name : "Autogenerated Test Run #{DateTime.now}"
    ...
    def start_test_run(project_id:, suite_id:)
      ...
      @testrail_http_client.send_post("add_run/#{project_id}", suite_id: suite_id, name: @run_name)
    end
